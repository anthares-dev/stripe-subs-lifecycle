        ...
        <div className="w-full inline-block border p-4 rounded-md">
          ...
          <div className="w-full">
            ...
            <form id="payment-form" onSubmit={handleSubmit}>
              ...
              <button
                id="submit-STUDIO"
                className="w-full bg-pasha hover:bg-white hover:shadow-outline hover:text-mick hover:border hover:border-black focus:shadow-outline text-white focus:bg-white focus:text-mick font-light py-2 px-4 rounded-md"
                type="submit"
              >
                <div className="">
