            ...
            <div className="flex items-center justify-between flex-wrap">
              <div className="w-full flex-1 flex items-center sm:w-0">
                {/* <p className="text-white truncate">
                  <strong className="font-medium text-mick md:hidden">
                    This is a Stripe Sample
                  </strong>
                  <strong className="hidden md:inline font-medium text-mick">
                    This is a Stripe Sample
                  </strong>
                  <span className="lg:hidden text-mick">
                    with Fixed Price Subscriptions with Cards. View code on
                    GitHub.
                  </span>

                  <span className="hidden lg:inline text-mick">
                    with Fixed Price Subscriptions with Cards. View code on
                    GitHub.
                  </span>
                </p> */}
              ...
              <div className="flex-shrink-0">
                <div className="rounded-md shadow-sm">
                  {/* <a
                    ...
                    className="flex items-center justify-center px-4 py-2 border text-sm leading-5 font-medium rounded text-mick bg-white hover:text-gray-600 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
                  >
                    View the guide →
                  </a> */}
                </div>
