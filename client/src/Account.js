  ...
  return (
    <div className="p-6">
      ...
      {subscriptionCancelled ? (
        <div>
          <div className="flex flex-wrap font-bold text-mick text-xl mt-6 mb-2">
            Subscription canceled
          </div>
          <div>
            <button
              className="bg-pasha hover:bg-white hover:shadow-outline hover:text-mick hover:border hover:border-black focus:shadow-outline text-white focus:bg-white focus:text-mick font-light py-2 px-4 rounded"
              type="button"
              onClick={() => resetDemo()}
            >
              Restart demo
          ...
          <div className="flex flex-wrap justify-center mt-4">
            <div className="md:w-2/5 w-full inline-block rounded-md p-4">
              <div
                ...
                className="text-center font-bold text-mick text-2xl"
              >
                Account settings
              </div>
