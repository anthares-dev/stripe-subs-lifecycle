        ...
        <div className="w-full rounded overflow-hidden border rounded-md p-4 mb-4">
          ...
          <div>
            ...
            <button
              ...
              className="bg-pasha hover:bg-white hover:shadow-outline hover:text-mick hover:border hover:border-black focus:shadow-outline text-white focus:bg-white focus:text-mick font-light py-2 px-4 rounded-lg mr-2"
              type="submit"
            >
            ...
            <button
              ...
              className="bg-pasha hover:bg-white hover:shadow-outline hover:text-mick hover:border hover:border-black focus:shadow-outline text-white focus:bg-white focus:text-mick font-light py-2 px-4 rounded-lg"
              type="submit"
            >
              <div className="w-auto -mx-2 md:mx-0">
                <span>Cancel</span>
