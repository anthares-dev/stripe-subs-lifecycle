  ...
  return (
    <div className="w-2/5 rounded overflow-hidden border rounded-md p-2">
      <div className="px-2 py-2">
        ...
        <p className="text-mick text-2xl font-extrabold">{product.price}</p>
        ...
        <div className="flex justify-center mt-6">
          {currentProductSelected ? (
            <button
              className="bg-pasha hover:bg-white outline-none hover:text-mick hover:border hover:border-black text-white focus:bg-white focus:text-mick font-light py-2 px-4 rounded-lg"
              type="submit"
            >
